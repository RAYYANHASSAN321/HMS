  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-3  col-md-6 col-sm-6">
        <div className="single-footer-widget">
          ...
          <p>At Han Luxury Hotel, we believe luxury is more than comfort—it is an unforgettable experience. Nestled in elegance and designed with sophistication, our hotel offers world-class hospitality for guests who seek the finest in life. </p>
        </div>
      </div>
      <div className="col-lg-3 col-md-6 col-sm-6">
        <div className="single-footer-widget">
    ...
    <div className="row footer-bottom d-flex justify-content-between align-items-center">
      <p className="col-lg-8 col-sm-12 footer-text m-0">{/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
        All rights reserved by <a>Luxury Stay </a>
